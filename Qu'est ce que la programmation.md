...
Lorsque vous mettez le programme en marche, le système applique alors les instructions dans l’ordre dans lequel est ont été écrites dans le programme afin d’atteindre l’objectif, de réaliser les opérations devant être réalisées. 
